...
use Illuminate\Support\Facades\Route;
 ...
 //Rutas nuevas de contactos
 Route::get('allContacto', 'contactoController@index');
 Route::post('createContacto', 'contactoController@store');
 Route::put('updateContacto/{id}', 'contactoController@update');
 Route::delete('deleteContacto/{id}', 'contactoController@destroy');
 Route::get('getideContacto/{id}', 'contactoController@buscarid');
 Route::put('editContacto/{id}', 'contactoController@edit');
 Route::get('getEstadoContac', 'contactoController@getEstadoContac');
